...
chroot kaynak apt-get install network-manager-gnome ukui* ukwm qt5-styles-ukui qt5-ukui-platformtheme -y

### İsteğe bağlı paketleri kuralım
chroot kaynak apt-get install blueman gvfs-backends inxi synaptic dde-calendar firefox-esr firefox-esr-l10n-tr -y
...
chroot kaynak apt-get install pardus-dolunay-grub-theme pardus-about pardus-installer -y
