...
calamares calamares-settings-debian xfce4 xfce4-goodies lightdm-gtk-greeter linux-image-amd64
firefox-esr sudo network-manager-gnome lightdm firmware-linux firmware-linux-nonfree firmware-misc-nonfree
firmware-iwlwifi firmware-realtek firmware-atheros firmware-amd-graphics plymouth plymouth-themes synaptic
EOF
